...
**Fase 1 — Perfil + vínculo (loop mínimo)**
...
**Fase 2 — Painel do nutricionista (monitorar)**
- `/app/pacientes` (lista com aderência resumida).
- `/app/pacientes/[id]` (visão do paciente: peso, dieta/macros, exames, hábitos,
  tratamento, Score) — somente leitura.
